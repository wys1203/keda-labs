...
kubectl apply -f "${LAB_DIR}/manifests/demo-cpu/namespace.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/demo-cpu/deployment.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/demo-cpu/service.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/demo-cpu/scaledobject.yaml" >/dev/null
...
kubectl apply -f "${LAB_DIR}/manifests/demo-prom/namespace.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/demo-prom/deployment.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/demo-prom/scaledobject.yaml" >/dev/null
...
kubectl apply -f "${LAB_DIR}/manifests/legacy-cpu/namespace.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/legacy-cpu/deployment.yaml" >/dev/null
kubectl apply -f "${LAB_DIR}/manifests/legacy-cpu/scaledobject.yaml" >/dev/null
